...
class MedarbejderTest {
    ...
    void opretDestillation_test_1() {
        ...
        Destillation destillation = new Destillation(LocalDate.of(2023, 11,29), LocalDate.of(2026,11,23), "Fire", "Byg", 300, 10, medarbejder);
        //Act
        Destillation faktiskResultat = medarbejder.opretDestillation(LocalDate.of(2023, 11,29), LocalDate.of(2026,11,23), "Fire", "Byg", 300, 10);
        //Assert
